// frontend/src/pages/SupplierReturns.jsx - MOBILE-FIRST RESPONSIVE VERSION WITH SKELETON LOADING
...
// Skeleton Components
const SkeletonCard = () => (
  <div className="bg-white rounded-lg sm:rounded-xl p-4 sm:p-6 border border-slate-200 shadow-sm animate-pulse">
    <div className="flex items-center justify-between mb-2 sm:mb-3">
      <div className="flex-1">
        <div className="h-3 sm:h-4 bg-slate-200 rounded w-20 sm:w-24 mb-2"></div>
        <div className="h-6 sm:h-8 bg-slate-300 rounded w-12 sm:w-16"></div>
      </div>
  ...
  <div className="bg-white rounded-lg sm:rounded-xl shadow-sm border border-gray-200 overflow-hidden animate-pulse">
    <div className="bg-linear-to-r from-red-50 to-orange-50 px-4 sm:px-6 py-3 sm:py-4 border-b border-gray-200">
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-2">
        <div className="flex-1">
          <div className="h-5 bg-slate-300 rounded w-32 sm:w-40 mb-2"></div>
    ...
    <div className="max-w-7xl mx-auto">
      ...
      <div className="mb-4 sm:mb-6">
        <div className="flex flex-col gap-3 sm:flex-row sm:justify-between sm:items-start">
          ...
          <div className="w-full sm:w-auto h-10 bg-slate-200 rounded-lg animate-pulse"></div>
        </div>
      </div>

      {/* Month Navigator Skeleton */}
      <div className="bg-white rounded-lg sm:rounded-xl shadow-sm border border-gray-200 p-3 sm:p-4 mb-4 sm:mb-6 animate-pulse">
